...
Tab1  <- read_excel(datacube, sheet = 2,  range = "A5:O140")
Tab2  <- read_excel(datacube, sheet = 3,  range = "A5:O140")
Tab3  <- read_excel(datacube, sheet = 4,  range = "A5:H49")
Tab4  <- read_excel(datacube, sheet = 5,  range = "A5:M16")
Tab5  <- read_excel(datacube, sheet = 6,  range = "A4:I28")
Tab6  <- read_excel(datacube, sheet = 7,  range = "A5:O140")
Tab7  <- read_excel(datacube, sheet = 8,  range = "A5:O140")
Tab8  <- read_excel(datacube, sheet = 9,  range = "A5:H49")
Tab9  <- read_excel(datacube, sheet = 10, range = "A5:M16")
Tab10 <- read_excel(datacube, sheet = 11, range = "A4:I28")
Tab11 <- read_excel(datacube, sheet = 12, range = "A5:U140")
Tab12 <- read_excel(datacube, sheet = 13, range = "A5:U140")
Tab13 <- read_excel(datacube, sheet = 14, range = "A5:K49")
Tab14 <- read_excel(datacube, sheet = 15, range = "A5:S16")
Tab15 <- read_excel(datacube, sheet = 16, range = "A5:L28")

# SA4 tables
Tab16 <- read_excel(datacube, sheet = 17, range = "A4:G11973")
Tab17 <- read_excel(datacube, sheet = 18, range = "A4:G11973")
Tab18 <- read_excel(datacube, sheet = 19, range = "A4:E3876")
Tab19 <- read_excel(datacube, sheet = 20, range = "A4:E972")
Tab20 <- read_excel(datacube, sheet = 21, range = "A4:F2116")

# SA3 tables
Tab21 <- read_excel(datacube, sheet = 22, range = "A4:G44831")
Tab22 <- read_excel(datacube, sheet = 23, range = "A4:G44831")
Tab23 <- read_excel(datacube, sheet = 24, range = "A4:E14524")
Tab24 <- read_excel(datacube, sheet = 25, range = "A4:E3634")
Tab25 <- read_excel(datacube, sheet = 26, range = "A4:F7924")
...
Tab1 <- Tab1 %>%
  setNames(T1_name) %>%
  pivot_longer(4:15, names_to = "Geog_cat", values_to = "val") %>%
...
Tab3 <- Tab3 %>%
  setNames(T3_name) %>%
  pivot_longer(3:8, names_to = "Geog_cat", values_to = "val") %>%
  mutate(Geog_type = "SEIFA")

Tab4 <- Tab4 %>%
  setNames(T4_name) %>%
  pivot_longer(2:13, names_to = "Geog_cat", values_to = "val") %>%
  separate(col = "Geog_cat", into = c("Unit", "Geog_cat"), sep = "_") %>%
  mutate(Geog_type = "SEIFA")

Tab5 <- Tab5 %>%
  setNames(T5_name) %>%
  pivot_longer(4:9, names_to = "Geog_cat", values_to = "val") %>%
  mutate(Geog_type = "SEIFA")
...
Tab11 <- Tab11 %>%
  setNames(T11_name) %>%
  pivot_longer(4:21, names_to = "Geog_cat", values_to = "val") %>%
  separate(col = "Geog_cat", into = c("Unit", "Geog_cat"), sep = "_") %>%
...
Tab13 <- Tab13 %>%
  setNames(T13_name) %>%
  pivot_longer(3:11, names_to = "Geog_cat", values_to = "val") %>%
  mutate(Geog_type = "State")

Tab14 <- Tab14 %>%
  setNames(T14_name) %>%
  pivot_longer(2:19, names_to = "Geog_cat", values_to = "val") %>%
  separate(col = "Geog_cat", into = c("Unit", "Geog_cat"), sep = "_") %>%
  mutate(Geog_type = "State")

Tab15 <- Tab15 %>%
  setNames(T15_name) %>%
  pivot_longer(4:12, names_to = "Geog_cat", values_to = "val") %>%
  mutate(Geog_type = "State")

Tab16 <- Tab16 %>%
  setNames(T16_name) %>%
  pivot_longer(6:7, names_to = "Unit", values_to = "val") %>%
  mutate(AUSNUT_code = as.character(AUSNUT_code))
